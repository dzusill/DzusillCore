...
* [Plugin Lifecycle](core-concepts/lifecycle.md)
* [Modules](core-concepts/modules.md)
* [Services](core-concepts/services.md)

## Configuration

* [Config Files](configuration/config.md)
* [Typed Config Wrappers](configuration/typed-config.md)
* [Reloading](configuration/reloading.md)

## Messages & Colors

* [Message Service](messages-and-colors/messages.md)
* [Colors & MiniMessage](messages-and-colors/colors.md)
...
* [Cooldowns](utilities/cooldowns.md)
* [Permissions](utilities/permissions.md)
