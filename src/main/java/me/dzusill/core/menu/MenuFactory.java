 ...
 * {@link MenuRegistry}, this is the menu analogue of constructing a {@code CoreCommand} for the command registry —
 * typically just a constructor reference, e.g. {@code ShopMenu::new}.
 */
@FunctionalInterface
