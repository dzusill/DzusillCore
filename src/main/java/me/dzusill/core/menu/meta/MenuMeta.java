 ...
 * {@link me.dzusill.core.command.meta.CommandMeta}. A {@link me.dzusill.core.menu.Menu} annotated
 * with this no longer needs to override {@code title()} / {@code size()}; the framework reads the
 * values reflectively in the {@code Menu} constructor.
 *
 * <pre>{@code
