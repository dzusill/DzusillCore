 ...
 *
 * <p>The module order is the startup order: foundation services first, then integrations, then the
 * menu subsystem, and finally the commands that depend on all of the above.</p>
 */
public class ExamplePlugin extends CorePlugin {
    ...
    protected String[] banner() {
        return new String[]{
                "",
                "  DzusillCore " + getPluginMeta().getVersion(),
