...
/**
 * Example command that opens a menu by key through the {@link MenuRegistry}, the GUI analogue of how a command is
 * registered once and dispatched by name. The registry resolves the player's context and enforces the menu's own
 * permission.
 */
