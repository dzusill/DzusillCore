 ...
 * {@link MinecraftVersion}. In the default (lenient) mode the registry returns a no-op adapter
 * instead, so plugins keep running with NMS-backed features disabled.
 */
