 ...
 * {@code cfg.getString("a.b.c")} across the codebase, subclasses expose intent-revealing getters
 * backed by a single {@link Config} instance, centralizing the key strings and default handling.
 *
 * <p>Example:
 * <pre>{@code
...
public abstract class AbstractConfig {
     ...
     * @param fileName     name used both as the bundled resource and the on-disk file
     */
