...
/**
 * Typed view over {@code config.yml}. Demonstrates the recommended pattern for the framework: every config key is
 * referenced exactly once, here, behind a descriptive getter.
 */
