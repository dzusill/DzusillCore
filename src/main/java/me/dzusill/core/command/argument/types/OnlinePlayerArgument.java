...
/**
 * Resolves a token to a currently-online {@link Player}, suggesting online player names for
 * autocomplete. Fails with {@link Messages#PLAYER_NOT_FOUND} when the player is offline/unknown.
 */
