...
/**
 * Resolves a token to an {@link OfflinePlayer} that has played on the server before, so commands
 * can target offline players (e.g. data edits). Suggests online player names for convenience.
 */
