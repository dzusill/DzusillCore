...
/**
 * Converts a single raw command token into a typed value and, optionally, contributes
 * tab-completion suggestions for that position. This is the polymorphic core of the command
 * framework: a command declares <em>what</em> each argument is, and the type knows <em>how</em>
 * to both parse and autocomplete it.
 *
...
public interface ArgumentType<T> {
     ...
     *
     * @throws CommandException if {@code raw} is not valid for this type
     */
     ...
     *
     * @param token the partial text typed so far
     */
